...
**Value over a vanilla agent**: A vanilla agent reports "job failed" with the error message. This agent classifies the failure type, determines the resolution path, and cites the relevant Red Hat documentation for the fix.
