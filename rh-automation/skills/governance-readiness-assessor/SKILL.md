...
This is non-negotiable. A finding without a Red Hat citation is incomplete. The audience must SEE that every assessment criterion and every recommendation traces to official Red Hat documentation -- this is the core value proposition over a vanilla agent.
